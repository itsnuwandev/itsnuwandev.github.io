...
const Index = () => {
  ...
  const featuredProjects = [
    {
      ...
      description:
        "Developed a system to manage stock inventory, track sales, and generate reports using a user-friendly interface.",
      image:
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8",
      tags: ["Java", "MySQL"],
      link: "/projects",
      code: "https://github.com/itsnuwandev/simple-stock-system.git",
    },
    {
      title: "PC Home - E-commerce Platform",
      description:
      ...
      link: "/projects",
      code: "https://github.com/itsnuwandev/pchome-ecommerce.git",
    },
    {
      title: "Test Project",
      description:
  ...
  const techStack = [
    ...
    { name: "Springboot", proficiency: 60 },
    { name: "Laravel", proficiency: 60 },
    { name: "Flutter", proficiency: 35 },
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                ...
                using React.js, Vue.js, Laravel, and Spring Boot to deliver
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                Experienced in developing robust desktop applications using
                Java, with expertise in GUI frameworks and database integration
                for comprehensive software solutions.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground text-center">
                ...
                focusing on cross-platform solutions and modern UI/UX design
                principles for Android and iOS.
              </p>
            </motion.div>
          </div>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-muted-foreground">
              A collection of technologies I work with to build web
              applications, desktop applications, mobile applications and solve complex problems.
            </p>
          </motion.div>
