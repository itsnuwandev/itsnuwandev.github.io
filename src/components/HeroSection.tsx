      ...
      <div className="container mx-auto px-4 z-10">
        <div className="flex items-center justify-center min-h-[70vh]">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Creating scalable, high-performance applications with modern
              technologies. Specialized in full-stack development, delivering
              robust solutions from concept to deployment that drive business
