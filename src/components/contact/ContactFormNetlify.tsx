...
const ContactFormNetlify = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Just need to submit to the same page with the correct format
      ...
      <div className="glass-panel p-6 rounded-lg">
        <div className="mb-4">
          ...
          <p className="text-sm text-muted-foreground">
            Your message will be delivered directly to my email for fastest
            response.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-muted-foreground text-center">
            ✉️ Messages are delivered directly to my email for fastest response
          </p>
        </form>
      </div>
    </motion.div>
